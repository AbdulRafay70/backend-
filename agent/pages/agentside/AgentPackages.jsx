                                ...
                                <div className="row mb-3 g-3">
                                  ...
                                  <div className="col-4 col-md-2">
                                    ...
                                    <div style={{ fontSize: "14px", color: "#333" }}>
                                      {(() => {
                                        const makkahZiyarat = pkg?.makkah_ziyarat_price || pkg?.makkah_ziyarat_selling_price || 0;
                                        const madinahZiyarat = pkg?.madinah_ziyarat_price || pkg?.madinah_ziyarat_selling_price || 0;
                                        const total = makkahZiyarat + madinahZiyarat;
                                        return total > 0 ? `Rs. ${Number(total).toLocaleString()}` : "N/A";
                                      })()}
                                    </div>
                                  </div>
                                  <div className="col-4 col-md-2">
                                    ...
                                    <div style={{ fontSize: "14px", color: "#333" }}>
                                      {pkg?.food_price > 0 || pkg?.food_selling_price > 0 ? `Rs. ${Number(pkg?.food_price || pkg?.food_selling_price || 0).toLocaleString()}` : "N/A"}
                                    </div>
                                  </div>
                              ...
                              <div className="col-lg-4">
                                <div className="package-summary">
                                  ...
                                  <p className="fw-semibold mb-3">
                                    {pkg?.adault_visa_price > 0 || pkg?.adault_visa_selling_price > 0
                                      ? `Rs. ${Number(pkg?.adault_visa_price || pkg?.adault_visa_selling_price || 0).toLocaleString()}`
                                      : 'N/A'}
                                  </p>

                                  <p className="text-muted small mb-1">Transport:</p>
                                  <p className="fw-semibold mb-3">
                                    {pkg?.transport_price > 0 || pkg?.transport_selling_price > 0
                                      ? `Rs. ${Number(pkg?.transport_price || pkg?.transport_selling_price || 0).toLocaleString()}`
                                      : (resolveTransportDisplay(pkg, orgIds) || 'N/A')}
                                  </p>
