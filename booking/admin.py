...
class BookingForm(forms.ModelForm):
	...
	def clean(self):
		...
		# Skip employee validation for public bookings
		if self.instance.pk and self.instance.is_public_booking:
			# For public bookings, preserve existing organization/branch/agency
			# Don't override with employee data
			return cleaned_data
